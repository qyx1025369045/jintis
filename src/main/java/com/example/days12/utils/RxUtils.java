package com.example.days12.utils;

import com.example.days12.bean.ApiException;
import com.example.days12.bean.BaseResponse;
                    ...
                    public ObservableSource<T> apply(final BaseResponse<T> tBaseResponse) throws Exception {
                        if (tBaseResponse.getErrorCode() == 0){
                            ...
                            return Observable.error(new
                                    ApiException(tBaseResponse.getErrorCode(),
